...
class D(nn.Module):
    ...
    def __init__(self, k, subletter, num):
        ...
        self.num = num
        self.name = "d{}{}_{}".format(subletter, num, str(k+1).zfill(3))
        self.k = k
...
for subletter in ["a", "b"]:
    for num in [1,2,3,4]:
        k_list = []
        for k_ in range(k):
            k_list.append(D(k_, subletter = subletter, num = num))
        d_dict["d{}{}".format(subletter, num)] = k_list
